    ...
    <div>
      ...
      <div className="Home2">
        <div className="Home-content2">
          ...
          <img className="avatar-size" alt="Cindy Baker"  src="https://images-na.ssl-images-amazon.com/images/M/MV5BMTUxMjM1MzgxMl5BMl5BanBnXkFtZTcwNDI0NDE5NQ@@._V1_UY256_CR4,0,172,256_AL_.jpg" />
          ...
          <img className="avatar-size" alt="Cindy Baker"  src="https://randomuser.me/api/portraits/women/65.jpg" />
